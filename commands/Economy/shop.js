...
module.exports = {
    ...
    execute: async (client, message, args, prefix, guild, color, channel) => {        
        ...
        let embed2 = new MessageEmbed()
            ...
            .addField("Dawn Stone", 'null use', true)
            .addField("Dusk Stone", 'null use', true)
            .addField("Fire Stone", 'null use', true)
            .addField("Ice Stone", 'null use', true)
        ...
        let embed8 = new MessageEmbed()
            ...
            .setDescription("You Can Buy Redeem With This command ")
            ...
            if (args[1].toLowerCase() == "forms") {
                ...
                if (args[2].toLowerCase() == "mew") {
                    let smew = new MessageEmbed()
                        ...
                        .addField("Shadow Mew", `\`${prefix}shopbuy 11  form shadow\``)
                        .setColor(color)
                    ...
                    let smew2 = new MessageEmbed()
                        ...
                        .addField("Shadow Mewtwo", `\`${prefix}shopbuy 11 form  shadow\``)
                        .setColor(color)
                    ...
                    let ssolgaleo = new MessageEmbed()
                        ...
                        .setDescription("All Shadow Pokémon costs 10,000 .")
                        .addField("Shadow Solgaleo", `\`${prefix}shopbuy 11 form shadow\``)
                        .setColor(color)
                    ...
                    let scelebi = new MessageEmbed()
                        ...
                        .setDescription("All Shadow Pokémon costs 10,000 .")
                        .addField("Shadow Celebi", `\`${prefix}shopbuy 11  form shadow\``)
                        .setColor(color)
                    ...
                    let slugia = new MessageEmbed()
                        ...
                        .setDescription("All Shadow Pokémon costs 10,000 .")
                        .addField("Shadow Lugia", `\`${prefix}shopbuy 11  form shadow\``)
                        .setColor(color)
