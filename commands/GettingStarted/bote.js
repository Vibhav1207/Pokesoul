...
module.exports = {
    ...
    async execute(client, message, args, prefix, guild, color, channel) {
        ...
        if (user.streak == 2) streak = "🔥🔥❌❌❌❌❌";
        if (user.streak == 3) streak = "🔥🔥🔥❌❌❌❌";
        if (user.streak == 4) streak = "🔥🔥🔥🔥❌❌❌";
        if (user.streak == 5) streak = "🔥🔥🔥🔥🔥❌❌";
        if (user.streak == 6) streak = "🔥🔥🔥🔥🔥🔥❌";
        if (user.streak > 6) streak = "🔥🔥🔥🔥🔥🔥🔥";
        ...
        let embed = new MessageEmbed()
            ...
            .addField("Diamond  Crate ", stuffs)
            .setColor("RANDOM")
            .setFooter("Once your vote is received, type .open diamond-crate")
        ...
        if (!args[0]) return message.channel.send(embed);
            ...
            if (t.voted == 1) {
                if (amount == 1) {
                    ...
                    await daily.save();
                    return message.reply(`You received a Redeem !`);
                } else {
                    ...
                    daily.time = Date.now() + 43200000;
                    await daily.save();
                    return message.reply(`You received ${amount} cc and diamond-crate`);
                }
            } else {
