    ...
    execute: async (client, message, args, prefix, guild, color, channel) => {
        ...
        let embed7 = new MessageEmbed()
            ...
            .addField(`Filters`,
                ...
                `**Support Server**: https://discord.gg/HWEzCGE3G6`)
        ...
        let embed8 = new MessageEmbed()
            ...
            .setDescription(`Gamble with other trainer. \n\n**Note: Gamble At Your own risk, if you lose high amount of money the ${client.user.username}  Team won't be responsible for that and ricks won't be returned.**`)
        ...
        if (!args[0]) {
            ...
            if (args[0] === "1") {
              ...
              message.channel.send(embed1)
                ...
                return message.author.send(auction)
