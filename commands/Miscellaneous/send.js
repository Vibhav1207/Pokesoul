...
module.exports = {
    ...
    .addField("Send Feedback to the Official Server",`Usage: \`${prefix}message feedback <message>\``)
    .addField("Send Bug Report to the Official Server",`Usage: \`${prefix}message bug <message>\``)
    .addField("Send A Suggestion fot the Bot to the Official Server",`Usage: \`${prefix}message suggestion <message>\``)
    .setColor(color)
