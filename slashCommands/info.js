...
module.exports = {
    ...
    trade: true,
    options: [
        { "Integer": { name: "pokemon", description: "The Pokémon id you wish to get information about.", required: true } },
    ],
    run: async (client, interaction, color, support, guild) => {
        ...
        let slot = interaction.options.getInteger("pokemon");
        let poke = user.pokemons1[slot - 1];
